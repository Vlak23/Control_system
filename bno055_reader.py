...
29
30while True:
		#gives the raw accelerometer readings m/s. Returns an empty tuple of length 3 when this property has been disabled by the current mode.
...
37    print("Accelerometer (m/s^2): {}".format(sensor.acceleration))
	#Gives the raw accelerometer readings, in m/s. Returns an empty tuple of length 3 when this property has been disabled the current mode. 
38    print("Magnetometer (microteslas): 
	#Gives the raw magnetometer readings in microtesla. Returns an empty tuple of length 3 when this property has been disabled by the current mode.
